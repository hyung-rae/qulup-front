...
const Terms = () => {
  return (
    <ScrollArea
      offsetScrollbars="y"
      h={200}
      style={{ border: `1px solid #424242`, borderRadius: '5px', padding: '5px' }}
    >
      <Box>
        ...
        (1) 홈페이지 회원 가입 및 관리
        <br />
        회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 제한적 본인확인제 시행에 따른
        본인확인, 서비스 부정 이용 방지, 만 14세 미만 아동의 개인정보 처리시 법정대리인의 동의 여부 확인, 각종
        고지․통지, 고충 처리 등의 목적
        <br />
        <br />
        (2) 재화 또는 서비스 제공
